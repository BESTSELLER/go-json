...
func TestUnmarshalEmbeddedUnexported(t *testing.T) {
	...
	tests := []struct {
		...
		ptr: new(S1),
		out: &S1{R: 2},
		err: fmt.Errorf("gojson: cannot set embedded pointer to unexported struct: gojson.embed1"),
	}, {
		...
		ptr: new(S5),
		out: &S5{R: 2},
		err: fmt.Errorf("gojson: cannot set embedded pointer to unexported struct: gojson.embed3"),
	}, {
